        ...
        $scope.click = function () {
            ...
            $httpClient.post(requestUrl).then(function (response) {
                ...
                if(response.data.type === "ERROR"){
                    ...
                    document.getElementById("error_msg_text").textContent = response.data.message;
                }
            }).catch(function (error) {
                document.getElementById("isa_error").style.visibility = 'visible';
                document.getElementById("error_msg_text").textContent = 'Server internal error contact admin';
            });
        }
